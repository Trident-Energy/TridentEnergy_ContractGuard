          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm transition-colors">
              ...
              <ul className="space-y-3 text-slate-600 dark:text-slate-300">
                ...
                <li className="flex items-start gap-2">
                  <CheckCircle size={18} className="text-green-500 mt-1 shrink-0" />
                  <span><strong>Visibility:</strong> Provide a single pane of glass for CFOs and Legal teams to track exposure.</span>
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle size={18} className="text-green-500 mt-1 shrink-0" />
          ...
          <div className="space-y-6">
            <div className="relative border-l-2 border-slate-200 dark:border-slate-700 ml-3 space-y-10">
              <div className="relative pl-8">
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400 mt-2 leading-relaxed">
                  Upon submission, the contract is locked. Notifications are sent to the CFO, Legal Lead, and Function Head.
                  All three must review. They can <strong>Request Changes</strong> (sends back to SCM) or <strong>Approve</strong>.
                </p>
              </div>
            ...
            <div className="bg-purple-50 dark:bg-purple-900/10 p-5 rounded-lg border border-purple-200 dark:border-purple-800 mt-6">
              ...
              <p className="text-sm text-slate-700 dark:text-slate-300 mb-3">
                Sometimes you need an expert opinion (e.g., HSE Manager for a hazardous waste contract) who is not in the automatic approval chain.
              </p>
